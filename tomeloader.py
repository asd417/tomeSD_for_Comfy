...
class CheckpointTomeLoader:
    ...
    def load_checkpoint(self, ckpt_name, ratio, output_vae=True, output_clip=True):
        ...
        modelpatcher, clip, vae, clipvision = comfy.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, embedding_directory=folder_paths.get_folder_paths("embeddings"))
